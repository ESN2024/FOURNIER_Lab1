// chenillard_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module chenillard_mm_interconnect_0 (
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> pio_1_s1_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_1_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // pio_1_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pio_1_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> pio_1_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> pio_1_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pio_2_s1_agent:cp_valid
	wire  [93:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_2_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // pio_2_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_2_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pio_2_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pio_2_s1_agent:cp_endofpacket
	...
	wire  [93:0] pio_1_s1_agent_rp_data;                                                             // pio_1_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_006:sink_data
	...
	wire         pio_1_s1_agent_rdata_fifo_src_valid;                                                // pio_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pio_1_s1_agent_rdata_fifo_src_data;                                                 // pio_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pio_1_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_003:in_0_ready -> pio_1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> pio_1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> pio_1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // pio_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> pio_1_s1_agent:rdata_fifo_sink_error
	wire         pio_2_s1_agent_rdata_fifo_src_valid;                                                // pio_2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pio_2_s1_agent_rdata_fifo_src_data;                                                 // pio_2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pio_2_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_004:in_0_ready -> pio_2_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pio_2_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pio_2_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // pio_2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pio_2_s1_agent:rdata_fifo_sink_error
	...
	chenillard_mm_interconnect_0_router router (
	...
	chenillard_mm_interconnect_0_router_001 router_001 (
	...
	chenillard_mm_interconnect_0_router_002 router_002 (
	...
	chenillard_mm_interconnect_0_router_002 router_003 (
	...
	chenillard_mm_interconnect_0_router_002 router_004 (
	...
	chenillard_mm_interconnect_0_router_005 router_005 (
	...
	chenillard_mm_interconnect_0_router_005 router_006 (
	...
	chenillard_mm_interconnect_0_router_005 router_007 (
	...
	chenillard_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux_003 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux_003 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux_003 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux_003 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_1_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
