...
module chenillard_mm_interconnect_0 (
	...
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> timer_0_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // timer_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_2_s1_agent:cp_channel
	...
	wire  [93:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> pio_0_s1_agent:cp_data
	...
	wire  [93:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_008:sink_data
	...
	chenillard_mm_interconnect_0_router_002 router_005 (
	...
	chenillard_mm_interconnect_0_router_006 router_006 (
	...
	chenillard_mm_interconnect_0_router_006 router_007 (
	...
	chenillard_mm_interconnect_0_router_006 router_008 (
	...
	chenillard_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_cmd_mux_004 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux_004 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	chenillard_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (timer_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
